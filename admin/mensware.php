...
<link rel="stylesheet" href="css/form.css">
    ...
    <title>SuPu Store | Add Product for men</title>
...
?>
<div class="container">
    <div class="title">Add Product</div><br><hr><br>
                ...
                <table>
                    ...
                    <tr>
                        <div class="input-box">
                            ...
                            <td colspan="2"><input type="text" name="category" id="category" class="abc" value="Mensware" disabled></td>
                        </div>
                    </tr>
