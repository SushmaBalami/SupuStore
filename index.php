    ...
    <div id="home">
        ...
        <div class="first-container">
            ...
            <div class="headdesc">
                ...
                <div class="imgpng">
                    <img src="images/supu.png" alt="" width="400px">
                </div>
            </div>
        </div>
                ...
                <div class="forms">
                    <div class="form login">
                        ...
                        <form action="login.php" method="post">
                            ...
                            <div class="forget">
                                <a href="#" class="text" style="text-decoration: none;">Forgot password?</a>
                            </div>
                        ...
                        <div class="login-signup">
                            <span class="text">Not a member?
                                <a href="a.php" class="text signup-link" style="text-decoration: none;">Signup Now</a>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <div id="service">
        ...
        <div class="second-container">
            ...
            <div class="servicegallery">
                <a href="mens.php">
                    <div class="item">
                        <img src="images/male.jpg" alt="" width="310px">
                        <h3>Mensware</h3>
                    </div>
                </a>
                <a href="womens.php">
                    <div class="item">
                        <img src="images/women.jpg" alt="" width="310px">
                        <h3>Womensware</h3>
                    </div>
                </a>
                <a href="kids.php">
                    <div class="item">
                        <img src="images/kids.jpg" alt="" width="310px">
                        <h3>Kidsware</h3>
                    </div>
                </a>
            </div>
